...
//            VelPitchOld = VelPitch;
            ...
            //From FX1 (hyobin added)
            dAccRoll =  (((double)((short)((mb.data[1] | (mb.data[2]<<8)))))/4.0)*0.4625*0.001*9.81;
            dAccPitch = (((double)((short)((mb.data[3] | (mb.data[4]<<8)))))/4.0)*0.4625*0.001*9.81;
