...
//    AlunumWMupperbody=PODOALDialog::GetALNumFromALName("WMupperbody_AL");
    ...
    AlnumWalkReady = PODOALDialog::GetALNumFromALName("WalkReady");
...
//        pLAN->SendCommand(cmd);
    ...
    ui->LE_ALGORITHM_STAGE->setText(str.sprintf("%d", PODO_DATA.UserM2G.valveMode));
    ui->LE_STEP_TIME->setText(str.sprintf("%f", des_t_step));
}
