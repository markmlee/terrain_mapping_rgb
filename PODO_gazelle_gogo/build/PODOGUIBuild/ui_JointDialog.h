...
public:
    ...
    QLabel *label_29;
    QLabel *label_36;
    QLineEdit *LE_JOINT_NKP2;
    QLineEdit *LE_JOINT_NKP1;
    QWidget *gridLayoutWidget_8;
    QGridLayout *gridLayout_9;
    QLabel *label_37;
    QLabel *label_38;
    QLineEdit *LE_JOINT_NKR;
    ...
    void setupUi(QDialog *JointDialog)
    {
        ...
        groupBox->setGeometry(QRect(10, 50, 301, 761));
        QFont font1;
        font1.setBold(true);
        font1.setWeight(75);
...
""));
        ...
        gridLayoutWidget_3->setGeometry(QRect(160, 700, 128, 31));
        ...
        gridLayoutWidget->setGeometry(QRect(10, 160, 131, 211));
        ...
        gridLayoutWidget_2->setGeometry(QRect(160, 160, 128, 211));
        ...
        gridLayoutWidget_4->setGeometry(QRect(10, 510, 131, 161));
        ...
        gridLayoutWidget_5->setGeometry(QRect(160, 510, 128, 161));
        ...
        gridLayoutWidget_6->setGeometry(QRect(10, 690, 128, 61));
        ...
        gridLayoutWidget_7->setGeometry(QRect(10, 80, 128, 61));
        ...
        LE_JOINT_NKP2 = new QLineEdit(gridLayoutWidget_7);
        LE_JOINT_NKP2->setObjectName(QStringLiteral("LE_JOINT_NKP2"));
        LE_JOINT_NKP2->setEnabled(false);
        sizePolicy.setHeightForWidth(LE_JOINT_NKP2->sizePolicy().hasHeightForWidth());
        LE_JOINT_NKP2->setSizePolicy(sizePolicy);
        LE_JOINT_NKP2->setMinimumSize(QSize(70, 20));
        LE_JOINT_NKP2->setMaximumSize(QSize(70, 20));
        LE_JOINT_NKP2->setFont(font2);
        LE_JOINT_NKP2->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_JOINT_NKP2->setReadOnly(true);

        gridLayout_8->addWidget(LE_JOINT_NKP2, 1, 1, 1, 1);

        LE_JOINT_NKP1 = new QLineEdit(gridLayoutWidget_7);
        LE_JOINT_NKP1->setObjectName(QStringLiteral("LE_JOINT_NKP1"));
        LE_JOINT_NKP1->setEnabled(false);
        sizePolicy.setHeightForWidth(LE_JOINT_NKP1->sizePolicy().hasHeightForWidth());
        LE_JOINT_NKP1->setSizePolicy(sizePolicy);
        LE_JOINT_NKP1->setMinimumSize(QSize(70, 20));
        LE_JOINT_NKP1->setMaximumSize(QSize(70, 20));
        LE_JOINT_NKP1->setFont(font2);
        LE_JOINT_NKP1->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_JOINT_NKP1->setReadOnly(true);

        gridLayout_8->addWidget(LE_JOINT_NKP1, 0, 1, 1, 1);

        gridLayoutWidget_8 = new QWidget(groupBox);
        gridLayoutWidget_8->setObjectName(QStringLiteral("gridLayoutWidget_8"));
        gridLayoutWidget_8->setGeometry(QRect(160, 80, 128, 61));
        ...
        LE_JOINT_NKR = new QLineEdit(gridLayoutWidget_8);
        LE_JOINT_NKR->setObjectName(QStringLiteral("LE_JOINT_NKR"));
        LE_JOINT_NKR->setEnabled(false);
        sizePolicy.setHeightForWidth(LE_JOINT_NKR->sizePolicy().hasHeightForWidth());
        LE_JOINT_NKR->setSizePolicy(sizePolicy);
        LE_JOINT_NKR->setMinimumSize(QSize(70, 20));
        LE_JOINT_NKR->setMaximumSize(QSize(70, 20));
        LE_JOINT_NKR->setFont(font2);
        LE_JOINT_NKR->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        LE_JOINT_NKR->setReadOnly(true);

        gridLayout_9->addWidget(LE_JOINT_NKR, 1, 1, 1, 1);

        LE_JOINT_NKY = new QLineEdit(gridLayoutWidget_8);
        LE_JOINT_NKY->setObjectName(QStringLiteral("LE_JOINT_NKY"));
        LE_JOINT_NKY->setEnabled(false);
        ...
        gridLayoutWidget_9->setGeometry(QRect(10, 390, 128, 100));
        ...
        gridLayout_7->addWidget(label_39, 2, 0, 1, 1);
        ...
        gridLayoutWidget_10->setGeometry(QRect(160, 390, 128, 100));
        ...
        gridLayout_10->addWidget(label_43, 2, 0, 1, 1);
    ...
    void retranslateUi(QDialog *JointDialog)
    {
        ...
        label_29->setText(QApplication::translate("JointDialog", "NKP2", 0));
        label_36->setText(QApplication::translate("JointDialog", "NKP1", 0));
        label_37->setText(QApplication::translate("JointDialog", "NKR", 0));
        label_38->setText(QApplication::translate("JointDialog", "NKY", 0));
        label_28->setText(QApplication::translate("JointDialog", "RF2", 0));
        label_26->setText(QApplication::translate("JointDialog", "RF1", 0));
        label_39->setText(QApplication::translate("JointDialog", "RF3", 0));
        label_40->setText(QApplication::translate("JointDialog", "RF4", 0));
        label_41->setText(QApplication::translate("JointDialog", "LF2", 0));
        label_42->setText(QApplication::translate("JointDialog", "LF1", 0));
        label_43->setText(QApplication::translate("JointDialog", "LF3", 0));
        label_44->setText(QApplication::translate("JointDialog", "LF4", 0));
